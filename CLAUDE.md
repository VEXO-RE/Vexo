# Guía Técnica Arquitectónica para IA (VEXO Real Estate)

Si eres un asistente de IA (Claude, GPT, Gemini, etc.) analizando o modificando este proyecto, debes adherirte estrictamente a las siguientes reglas actualizadas al último estado del proyecto:

## 1. Reglas de Entorno y Directorio (Estricto)
*   **Directorio Único:** Todo el trabajo se realiza exclusivamente en `C:\Users\HP-Home\Documents\Projectos_Rosalia\VEXO_MASTER_OPTIMIZADO`. No busques ni inventes archivos fuera de esta ruta.
*   **Archivos de Edición Manual:** Solo puedes sugerir modificaciones directas a `public/index.html` y `public/vexo-magic.js`.
